    ...
    <Modal visible={isVisible} animationType="slide" onRequestClose={onClose}>
      ...
      >
        ...
        >
          ...
          <Text
            className={`text-lg font-black ${isDarkMode ? "text-slate-100" : "text-gray-900"}`}
          >
            {header}
          </Text>
        ...
        >
          <View
            className={`flex-row items-center border rounded-xl px-3 py-1 ${
              isDarkMode
                ? "bg-slate-950 border-slate-800"
          ...
          >
            ...
            {searchQuery.length > 0 && (
              <TouchableOpacity onPress={() => setSearchQuery("")}>
                <Text
                  className={`px-2 text-xs ${isDarkMode ? "text-slate-400" : "text-gray-400"}`}
                >
                  Clear
                </Text>
              </TouchableOpacity>
        ...
        <FlatList
            ...
            return (
              <TouchableOpacity
                ...
                className={`flex-row items-center p-4 border-b ${
                  isSelected
                    ? isDarkMode
                      ? "bg-indigo-950/40 border-slate-800"
                      : "bg-indigo-50 border-gray-50"
                    : isDarkMode
                      ? "bg-slate-900 border-slate-800"
          ...
          ListEmptyComponent={
            <View className="p-10 items-center">
              <Text className={isDarkMode ? "text-slate-500" : "text-gray-400"}>
  ...
  return (
    ...
    >
      <View className="flex-1 bg-black/50 justify-center items-center px-6">
        ...
        >
          <Text
            className={`text-xl font-black mb-2 ${isDarkMode ? "text-slate-100" : "text-gray-900"}`}
          >
            Group Name
          </Text>
          <Text
            className={`mb-4 ${isDarkMode ? "text-slate-400" : "text-gray-500"}`}
          >
          ...
          <View className="flex-row space-x-3">
            ...
            >
              <Text className={isDarkMode ? "text-slate-400" : "text-gray-500"}>
                Back
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text
                className={`font-bold ${groupName.trim().length > 2 ? "text-white" : isDarkMode ? "text-indigo-900" : "text-white"}`}
              >
                Create Group
              </Text>
            </TouchableOpacity>
      ...
      >
        ...
        >
          ...
          <View className="items-center">
            ...
            <Text
              className={`text-[10px] font-bold uppercase tracking-tighter ${isDarkMode ? "text-slate-500" : "text-gray-400"}`}
            >
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View className="p-20 items-center">
              <Text
                className={`text-center font-medium ${isDarkMode ? "text-slate-500" : "text-gray-400"}`}
              >
