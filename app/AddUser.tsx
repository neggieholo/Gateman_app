...
import { createSubUser, getS3UploadedUrl } from "./services/api";
...
export default function AddUserForm() {
  ...
  return (
    ...
    >
      ...
      >
        A split temporary password will been sent to the sub-account
        holder&apos;s email and phone line. Both halves must be combined to
        complete the initial login. It is strongly advised that they change
        their password immediately upon their first successful session.
      </Text>
        ...
        <View className="mb-4">
          ...
          <PhoneInput
            ...
            textInputStyle={{
              ...
              fontSize: 14,
              fontWeight: "500",
              height: 45, // Matched to container height
              paddingVertical: 0,
            }}
            codeTextStyle={{
              color: isDarkMode ? "#e2e8f0" : "#111827",
