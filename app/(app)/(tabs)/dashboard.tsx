        ...
        <View className="mb-6 bg-white p-5 rounded-3xl border border-gray-100 shadow-sm">
          ...
          <TouchableOpacity className="flex-row items-center bg-indigo-50 p-3 rounded-xl">
            <View className="flex-1">
              <Text className="text-indigo-900 font-bold text-xs">
                New Estate Notice
              </Text>
              <Text className="text-indigo-700 text-[10px]">
                Gate maintenance scheduled for Saturday...
              </Text>
            </View>
          ...
          <View className="bg-emerald-50 p-4 rounded-2xl border border-emerald-100 flex-row items-center">
            ...
            <View>
              ...
              <Text className="text-emerald-700 text-xs">
                Tomorrow, 10:00 AM • Community Center
              </Text>
            </View>
          </View>
        </View>
