...
const InvoiceListItem: React.FC<InvoiceItemProps> = ({
  title,
  icon: Icon,
  color,
  onPress,
...
export default function InvoicesScreen() {
  ...
  const handleOutstandingInvoices = () =>
    console.log("Navigate to Outstanding Invoices");
  const handleUtilityPayments = () =>
    console.log("Navigate to Utility Payments");
