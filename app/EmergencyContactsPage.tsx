...
const EmergencyContactsPage = () => {
  ...
  return (
    <>
      {/* <TestCallButton /> */}
      <View
        className={`flex-1 p-6 ${isDarkMode ? "bg-slate-950" : "bg-slate-50"}`}
      >
        ...
        <View className="mb-6">
          <Text
            className={`font-bold text-base ${isDarkMode ? "text-slate-400" : "text-slate-500"}`}
          >
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (
              ...
              >
                <View
                  className={`p-4 rounded-2xl mr-4 ${isUrgent ? "bg-rose-100" : "bg-indigo-100"}`}
                >
                  <ShieldAlert
                    size={24}
                    color={isUrgent ? "#e11d48" : "#4f46e5"}
                  />
                </View>
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-slate-400 font-bold tracking-widest">
                    {item.phone}
                  </Text>
                </View>
          ...
          ListEmptyComponent={
            <View className="items-center mt-20 opacity-40">
              ...
              <Text
                className={`font-black mt-6 text-center text-lg ${isDarkMode ? "text-slate-400" : "text-slate-600"}`}
              >
                No contacts found
              </Text>
            </View>
